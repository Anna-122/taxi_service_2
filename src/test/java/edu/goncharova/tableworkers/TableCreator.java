...
public class TableCreator {
    ...
    public static List<User> initUserTable() throws SQLException {
        ...
        allUsers.add(new User("anna.s.goncharova.2001@gmail.com", "123", "Anna", "Goncharova"));
        allUsers.add(new User("anna.s1.goncharova.2001@gmail.com", "123", "Anna1", "Goncharova1"));
        allUsers.add(new User("anna.s2.goncharova.2001@gmail.com", "123", "Anna2", "Goncharova2"));
        allUsers.add(new User("anna.s3.goncharova.2001@gmail.com", "123", "Anna3", "Goncharova3"));
    ...
    public static List<Admin> initAdminTable() throws SQLException {
        ...
        allAdmins.add(new Admin("anna.s.goncharova.2001@gmail.com", "123", "Anna", "Goncharova"));
