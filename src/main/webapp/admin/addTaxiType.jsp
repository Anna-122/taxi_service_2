...
<div class="w3-card-4">
    <div class="w3-container ">
        <form name="addTaxiTypeForm" method="POST" action="controller">
            ...
            <input type="text" name="fare" value="" class="w3-input w3-animate-input w3-border w3-round-large"
                   style="width: 30%"/>
            <br/>
            <button type="submit" class="w3-btn w3-gradient w3-round-large w3-margin-bottom"><fmt:message key="button.add.taxi.type"/></button>
