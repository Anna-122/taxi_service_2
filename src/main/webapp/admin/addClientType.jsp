...
<div class="w3-card-4">
    <div class="w3-container ">
        <form name="addClientTypeForm" method="POST" action="controller">
            ...
            <div class="w3-text-white">Client type name<br/></div>
            <input type="text" name="name" value="" class="w3-input w3-animate-input w3-border w3-round-large"
                   style="width: 30%"/>

            <div style="color: #ffffff"><fmt:message key="text.discount"/> (0-100)<br/></div>
            <input type="text" name="discount" value="" class="w3-input w3-animate-input w3-border w3-round-large"
                   style="width: 30%"/>
            <div style="color: #ffffff"><fmt:message key="text.minimum.money.spent"/><br/></div>
            <input type="text" name="moneyspent" value="" class="w3-input w3-animate-input w3-border w3-round-large"
                   style="width: 30%"/>
            <br/>
...
<div class="w3-container w3-opacity w3-right-align w3-padding">
    <button class="w3-btn w3-gradient w3-round-large w3-border"
            onclick="location.href='/taxi_service/admin/controller?command=clienttypes'"><fmt:message key="text.back.to.taxi"/>
    </button>
</div>
</body>
</html>
