...
public class SecurityConfiguration {
    ...
    private SecurityConfiguration() {
        ...
        grant.put(CommandFactory.ADD_TAXI_TYPE, ADMIN);
        grant.put(CommandFactory.TAXI_TYPES, ADMIN);
        grant.put(CommandFactory.UPDATE_TAXI_TYPE, ADMIN);
        grant.put(CommandFactory.CLIENT_TYPES, ADMIN);
        grant.put(CommandFactory.ADD_CLIENT_TYPE, ADMIN);
        grant.put(CommandFactory.UPDATE_CLIENT_TYPE, ADMIN);
